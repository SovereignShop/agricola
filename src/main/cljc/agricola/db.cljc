(ns agricola.db
  (:require
   ...
   [agricola.constants.ui-views :as views]
   [agricola.constants.ui-splits :as splits]
...
(def schema
  [{:db/ident       :session/user
   ...
   {:db/ident       :game/round
    ...
    :db/cardinality :db.cardinality/one
    :prop/group     true}
   {:db/ident       :agricola.team/id
    :db/valueType   :db.type/uuid
    :db/cardinality :db.cardinality/one
    :prop/group     true}
   {:db/ident       :agricola.team/name
    :db/valueType   :db.type/string
    :db/cardinality :db.cardinality/one
    :prop/group     true}
   {:db/ident       :agricola.team/color
    :db/valueType   :db.type/keyword
    :db/cardinality :db.cardinality/one
    :prop/group     true}
   {:db/ident       :agricola.team/players
    :db/valueType   :db.type/ref
    :db/cardinality :db.cardinality/many
    :prop/group     true}
   {:db/ident       :agricola.player/id
    :db/valueType   :db.type/uuid
    :db/cardinality :db.cardinality/one
    :prop/group     true}
   {:db/ident       :agricola.player/user
    :db/valueType   :db.type/ref
    :db/cardinality :db.cardinality/one
    :prop/group     true}
   {:db/ident       :agricola.player/type
    :db/valueType   :db.type/keyword
    :db/cardinality :db.cardinality/one
    :prop/group     true}
   {:db/ident       :agricola.turn/word
    :db/valueType   :db.type/string
    :db/cardinality :db.cardinality/one
    :prop/group     true}
   {:db/ident       :agricola.turn/number
    :db/valueType   :db.type/number
    :db/cardinality :db.cardinality/one
    :prop/group     true}
   {:db/ident       :agricola.turn/guesses
    :db/valueType   :db.type/ref
    :db/cardinality :db.cardinality/many
    :prop/group     true}
   {:db/ident       :agricola.turn/submitted?
    :db/valueType   :db.type/boolean
    :db/cardinality :db.cardinality/one
    :prop/group     true}
   {:db/ident       :agricola.turn/team
    :db/valueType   :db.type/ref
    :db/cardinality :db.cardinality/one
    :prop/group     true}
   {:db/ident       :agricola.round/number
    ...
    :db/cardinality :db.cardinality/one
    :prop/group     true}
   {:db/ident       :agricola.round/turns
    :db/valueType   :db.type/ref
    :db/cardinality :db.cardinality/many
    :prop/group     true}
   {:db/ident       :agricola.round/current-turn
    :db/valueType   :db.type/ref
    :db/cardinality :db.cardinality/one
    :prop/group     true}
   {:db/ident       :agricola.round/current-team
    :db/valueType   :db.type/ref
    :db/cardinality :db.cardinality/one
    :prop/group     true}
   {:db/ident       :agricola.round/winning-team
    :db/valueType   :db.type/ref
    :db/cardinality :db.cardinality/one
    :prop/group     true}
   {:db/ident       :agricola.round/blue-cards-count
    :db/valueType   :db.type/number
    :db/cardinality :db.cardinality/one
    :prop/group     true}
   {:db/ident       :agricola.round/red-cards-count
    :db/valueType   :db.type/number
    :db/cardinality :db.cardinality/one
    :prop/group     true}
   {:db/ident       :agricola.piece/round
    :db/valueType   :db.type/ref
    :db/cardinality :db.cardinality/one
    :prop/group     true}
   {:db/ident       :agricola.piece/type
    ...
    :db/cardinality :db.cardinality/one
    :prop/group     true}
   {:db/ident       :agricola.word-card/character-card
    :db/valueType   :db.type/ref
    :db/cardinality :db.cardinality/one
    :prop/group     true}
   {:db/ident       :agricola.word-card/position
    :db/valueType   :db.type/string
    :db/cardinality :db.cardinality/one
    :prop/group     true}
   {:db/ident       :agricola.word-card/word
    :db/valueType   :db.type/string
    :db/cardinality :db.cardinality/one
    :prop/group     true}
   {:db/ident       :agricola.character-card/played?
    :db/valueType   :db.type/boolean
    :db/cardinality :db.cardinality/one
    :prop/group     true}
   {:db/ident       :agricola.character-card/role
    :db/valueType   :db.type/keyword
    :db/cardinality :db.cardinality/one
    :prop/group     true}
   {:db/ident       :ui/type
